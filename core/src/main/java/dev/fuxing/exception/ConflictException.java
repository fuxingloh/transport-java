 ...
 * Time: 13:54
 */
public final class ConflictException extends TransportException {

    static {
        ExceptionParser.register(ConflictException.class, ConflictException::new);
    }

    ConflictException(TransportException e) {
        super(e);
    }
    ...
    /**
     * @param throwable safe exception for user to fix the problem.
     */
